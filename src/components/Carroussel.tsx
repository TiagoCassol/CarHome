...
export default function Carroussel() {
    ...
    const images = ["/carro3.jpg", "/carro2.jpg", "/carro1.jpg"]; // use public absolute paths
    ...
    return (
        <div className="w3-content w3-display-container carousel-container" style={{ maxWidth: "1200px" }}>
            {images.map((image, index) =>
                <img
                  key={index}
                  className="mySlides carousel-img"
                  src={image}
                  alt={`Carro ${index + 1}`}
                  loading="lazy"
            ...
            <div className="w3-center w3-container w3-section w3-large w3-text-white w3-display-bottommiddle" style={{ width: "100%" }}>
                <div className="w3-left w3-text-black" onClick={() => plusDiv(-1)}>&#10094;</div>
                <div className="w3-right w3-text-black" onClick={() => plusDiv(1)}>&#10095;</div>
